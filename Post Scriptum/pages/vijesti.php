...
<head>
	...
	<title>Post Scriptum - Vijesti</title>
...
<body>
	...
	<header>
		...
		<!-- Banner -->
		<div class="banner banner-vijesti">
			<h2>Post scriptum</h2>
			<p>Vijesti</p>
		</div>
		  ...
		  <div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="vijesti.php">Vijesti<span class="sr-only">(current)</span></a></li>
					<li class="dropdown">
	...
	<div class="container">
			...
			<article class="article-4-col col-md-4 col-sm-4">
				<a href="">
					...
					<div class="big-title-container">
						<small class="news category-outlined">VIJESTI</small>
		...
		<div class="row">
			<div class="category-header-container col-md-8 col-sm-8 col-xs-12 top-story clearfix">
				<ul>
					<li style="float: left;"><h4><b><a href="#" class="top-story">Vijesti</a></b></h4></li>
				</ul>
