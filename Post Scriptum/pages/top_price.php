...
<body>
		  ...
		  <div class="container">
		    ...
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="active">
						<a href="top_price.php">Top priče<span class="sr-only">(current)</span></a>
					</li>
	...
	<div class="container">
		...
		<section class="row">
			<!-- Top story article -->
			<article class="col-md-8 col-sm-12 col-xs-12 article-top-story">
				<a href="">
			...
			<article class="article-big col-md-4 col-sm-7 col-xs-12 hidden-sm hidden-xs">
				<a href="">
