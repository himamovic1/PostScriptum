...
<head>
	...
	<title>Post Scriptum - Politika</title>
...
<body>
	...
	<header>
		...
		<!-- Banner -->
		<div class="banner banner-politika">
			<h2>Post scriptum</h2>
			<p>Politika</p>
		</div>
		    ...
		    <div class="collapse navbar-collapse" id="navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="active dropdown">
						<a href="politika.php">Politika<span class="sr-only">(current)</span></a>
	...
	<div class="container">
			...
			<article class="article-4-col col-md-4 col-sm-4">
				<a href="">
					...
					<div class="big-title-container">
						<small class="politics category-outlined">POLITIKA</small>
		...
		<!-- Category header -->
		<div class="row">
			<div class="category-header-container col-md-8 col-sm-8 col-xs-12 politics clearfix">
				<ul>
			...
			<div class="category-header-container col-md-4 col-sm-4 hidden-xs politics clearfix">
				<ul>
